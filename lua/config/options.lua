...
-- Enable wrapping for specified file types
vim.api.nvim_create_autocmd("FileType", {
  ...
  callback = function()
    vim.opt_local.wrap = true      -- Enables line wrapping
    vim.opt_local.linebreak = true -- Stops line wrapping in the middle of a word
  end
})
